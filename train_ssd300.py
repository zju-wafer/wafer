...
VOC_2007_images_dir      = './JPEGImages/'
# VOC_2012_images_dir      = '../../datasets/VOCdevkit/VOC2012/JPEGImages/'

# The directories that contain the annotations.
VOC_2007_annotations_dir      = './Annotations/'
# VOC_2012_annotations_dir      = '../../datasets/VOCdevkit/VOC2012/Annotations/'

# The paths to the image sets.
VOC_2007_train_image_set_filename    = './ImageSets/Main/train.txt'
# VOC_2012_train_image_set_filename    = '../../datasets/VOCdevkit/VOC2012/ImageSets/Main/train.txt'
VOC_2007_val_image_set_filename      = './ImageSets/Main/val.txt'
# VOC_2012_val_image_set_filename      = '../../datasets/VOCdevkit/VOC2012/ImageSets/Main/val.txt'
VOC_2007_trainval_image_set_filename = './ImageSets/Main/trainval.txt'
# VOC_2012_trainval_image_set_filename = '../../datasets/VOC/evkit/VOC2012/ImageSets/Main/trainval.txt'
VOC_2007_test_image_set_filename     = './ImageSets/Main/test.txt'
...
classes = ['background','pool','extra','edgebreak','lack']
...
model_checkpoint = ModelCheckpoint(filepath='ssd300_model_liehen_expand.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
